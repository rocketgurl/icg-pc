...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'Store', 'LocalStorageSync', 'CrippledClientSync', 'xmlSync', 'amplify'], function($, _, Backbone, Store, LocalStorageSync, CrippledClientSync, XMLSync, amplify) {
    var BaseModel;
