...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'amplify', 'LocalStorageSync', 'CrippledClientSync', 'xmlSync'], function($, _, Backbone, amplify, LocalStorageSync, CrippledClientSync, XMLSync) {
    var BaseModel;
