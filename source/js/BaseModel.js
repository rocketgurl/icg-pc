...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'Store', 'amplify', 'LocalStorageSync', 'CrippledClientSync', 'xmlSync', 'xml2json'], function($, _, Backbone, Store, amplify, LocalStorageSync, CrippledClientSync, XMLSync) {
    var BaseModel;
