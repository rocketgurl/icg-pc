...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'Store', 'LocalStorageSync', 'CrippledClientSync', 'xmlSync'], function($, _, Backbone, Store, LocalStorageSync, CrippledClientSync, XMLSync) {
    var BaseModel;
