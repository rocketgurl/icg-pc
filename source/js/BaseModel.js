...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'Store', 'LocalStorageSync', 'CrippledClientSync', 'xmlSync', 'amplify_core', 'amplify_store'], function($, _, Backbone, Store, LocalStorageSync, CrippledClientSync, XMLSync, amplify) {
    var BaseModel;
