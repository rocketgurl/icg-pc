...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'UserModel', 'ConfigModel', 'WorkspaceStateModel', 'WorkspaceStateCollection', 'WorkspaceLoginView', 'WorkspaceCanvasView', 'WorkspaceNavView', 'WorkspaceRouter', 'Messenger', 'base64', 'MenuHelper', 'AppRules', 'Helpers', 'Cookie', 'xml2json', 'modules/SearchContextCollection'], function($, _, Backbone, UserModel, ConfigModel, WorkspaceStateModel, WorkspaceStateCollection, WorkspaceLoginView, WorkspaceCanvasView, WorkspaceNavView, WorkspaceRouter, Messenger, Base64, MenuHelper, AppRules, Helpers, Cookie, xml2json, SearchContextCollection) {
      ...
      set_nav_state: function() {
        ...
        if ((this.current_state != null) && (this.workspace_state != null)) {
          ...
          if (this.workspace_state === void 0 || _.isEmpty(this.workspace_state)) {
            this.workspace_state = this.Workspaces.create(this.current_state);
          }
