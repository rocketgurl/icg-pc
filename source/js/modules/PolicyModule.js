...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'mustache', 'modules/PolicyView', 'modules/PolicyModel', 'amplify_core', 'amplify_store'], function($, _, Backbone, Mustache, PolicyView, PolicyModel, amplify) {
    var PolicyModule;
