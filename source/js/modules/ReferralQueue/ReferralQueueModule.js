...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'mustache', 'modules/ReferralQueue/ReferralQueueView', 'modules/ReferralQueue/ReferralTaskCollection', 'loader'], function($, _, Backbone, Mustache, ReferralQueueView, ReferralTaskCollection, CanvasLoader) {
    var ReferralQueue;
