...
(function() {
  ...
  define(['jquery', 'underscore', 'backbone', 'mustache', 'modules/ReferralQueue/ReferralQueueView', 'modules/ReferralQueue/ReferralTaskCollection', 'loader', 'Messenger', 'Helpers'], function($, _, Backbone, Mustache, ReferralQueueView, ReferralTaskCollection, CanvasLoader, Messenger, Helpers) {
    var ReferralQueue;
    return ReferralQueue = (function() {
      ...
      ReferralQueue.prototype.load = function() {
        var _this = this;
        return Helpers.callback_delay(200, function() {
