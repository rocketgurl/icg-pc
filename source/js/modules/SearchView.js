...
(function() {
  ...
  define(['BaseView', 'mustache', 'Messenger', 'modules/SearchPolicyCollection', 'text!templates/tpl_search_container.html'], function(BaseView, Mustache, Messenger, SearchPolicyCollection, tpl_search_container) {
    var SearchView;
