...
(function() {
  ...
  define(['BaseView', 'Messenger', 'text!templates/tpl_policy_container.html', 'text!templates/tpl_ipm_header.html', 'swfobject'], function(BaseView, Messenger, tpl_policy_container, tpl_ipm_header, swfobject) {
    var PolicyView;
    PolicyView = BaseView.extend({
      ...
      show_overview: function() {
        ...
        return this.resize_element(this.policy_summary);
      },
