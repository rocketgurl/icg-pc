...
(function() {
  ...
  define(['require', 'jquery', 'underscore', 'mustache', 'text!templates/tpl_main_nav.html', 'text!templates/tpl_sub_nav_container.html', 'text!templates/tpl_sub_nav_ul.html', 'xml2json'], function(require, $, _, Mustache, tpl_main_nav, tpl_sub_nav_container, tpl_sub_nav_ul) {
    var MenuHelper;
    MenuHelper = {
      identity: null,
      ixconfig: null,
