define [
  ...
  class ReversePaymentAction extends IPMActionView
    ...
    ready : ->
      super
      @fetchTemplates(@MODULE.POLICY, 'reverse-payment', @processView)
    ...
    submit : (e) ->
      ...
      @VALUES.formValues.paymentAmount = \
        @Helpers.formatMoney(@VALUES.formValues.paymentAmount) ? null
