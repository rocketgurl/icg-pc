define [
  'BaseView',
  'Messenger',
  'modules/Quoting/QuotingChangeSet',
  'Apparatchik'
], (BaseView, Messenger, QuotingChangeSet, Apparatchik) ->
  ...
  #
  #
  class QuotingActionView extends BaseView
    ...
    initialize : (options) ->
      ...
      @ChangeSet      = new QuotingChangeSet(@MODULE.POLICY, @PARENT_VIEW.view_state, @MODULE.USER)
      ...
      # We need to validate form submits -- NOTE: REMOVED FOR UNLOCK QUOTE, NOT NECESSARY
    ...
    submit : (e) =>
      ...
      @PARENT_VIEW.insert_loader('Processing...') # Add loader
